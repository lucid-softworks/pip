...
// Latin American Spanish — at A1 level mostly identical to peninsular Spanish.
// Differences (vosotros/ustedes, vocabulary like coche/carro, etc.) emerge
// past A1; we'll diverge as later units are written.
export const spanishLatam: LanguageContent = {
  prefix: 'mx',
  source: 'en-US',
  target: 'es-MX',
  ...
  family: [
    { source: 'mother', target: 'mamá' },
    { source: 'father', target: 'papá' },
